                                    ...
                                    <center>
                                        ...
                                        {this.state.subscriptionKey ?
                                            [this.state.captureOn ?
                                                <div key="captureOn">
                                                    < Button key="captureOnce" color="primary" style={{ width: '200px' }} onClick={this.capture} disabled >Analisar Frame</Button>
                                                    <label style={{ float: 'right', marginRight: 50 }}>
                                                        <span style={{ fontSize: 20, verticalAlign: 'top' }}>Analisar Vídeo {}</span>
                                                        <Switch onChange={this.handleSwitchChange} checked={this.state.captureOn} />
                                                    </label>
                                                </div> :
                                                <div key="captureOff">
                                                    < Button key="captureOnce" color="primary" style={{ width: '200px' }} onClick={this.capture}>Analisar Frame</Button>
                                                    <label style={{ float: 'right', marginRight: 50 }}>
                                                        <span style={{ fontSize: 20, verticalAlign: 'top' }}>Analisar Vídeo {}</span>
                                                        <Switch onChange={this.handleSwitchChange} checked={this.state.captureOn} />
                                                    </label>
